...
//   const [startDate, setStartDate] = useState('');
//   const [endDate, setEndDate] = useState('');
//   const [capacity, setCapacity] = useState(1); // Default capacity is set to 1
//   const [availableRooms, setAvailableRooms] = useState(null);
...
//           start_date: startDate,
//           end_date: endDate,
//           capacity: parseInt(capacity, 10), // Parse capacity as an integer
//         }),
//       });
...
//     setCapacity((prevCapacity) => (prevCapacity + 1 <= 7 ? prevCapacity + 1 : prevCapacity));
//   };

//   const handleDecrement = () => {
//     setCapacity(capacity - 1 >= 1 ? capacity - 1 : 1);
//   };
